...
##### 3. ตรวจสอบจากแนวทแยงจากซ้ายตัวบนแถวแรก CheckDiagonalLeftTopToBottomValue
	...
	- กำหนดเริ่มต้นเป็น 1($i) เพราะจะตรวจสอบแถวที่ 2 เปรียบเทียบกับแถวแรกบนสุด (สังเกตว่าลำดับมุมทแยง Row และ Column จะเป็นค่า $i เหมือนกัน ไล่ลงมาจนด้านล่างสุด)
